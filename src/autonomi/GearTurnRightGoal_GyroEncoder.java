...
public class GearTurnRightGoal_GyroEncoder extends CommandGroup {
    ...
    public  GearTurnRightGoal_GyroEncoder() {
    	...
    	addSequential(new DriveStraightGyroVelocity(-.5,-10,false));  //distance and speed DIMENSIONS TBD
    	addSequential(new DriveTurnGyroInPlace(15,.5));	//angle, rate DIMENSIONS TBD
